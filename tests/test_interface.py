...
def test_antiferro_chain():
    ...
    _test_ref_data('antiferro_chain', *omegasum(*hamiltonian.energies_and_intensities(QVECS, use_rust=False,
...
def test_antiferro_with_field():
    ...
    _test_ref_data('antiferro_chain_with_field', *omegasum(*hamiltonian.energies_and_intensities(QVECS, field=[0,0,7],
...
def test_kagome_antiferro():
    ...
    _test_ref_data('kagome_antiferro', *omegasum(*hamiltonian.energies_and_intensities(QVECS, use_rust=False,
...
def test_tri_antiferro():
    ...
    _test_ref_data('tri_antiferro', *omegasum(*hamiltonian.energies_and_intensities(QVECS, use_rust=False,
...
def test_square_antiferro():
    ...
    _test_ref_data('square_antiferro', *omegasum(*hamiltonian.energies_and_intensities(QVECS, use_rust=False,
