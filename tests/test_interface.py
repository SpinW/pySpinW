...
def _test_ref_data(test_name, energy, intensity, ignoreQ=None, ref_id=1):
    eref, intref = omegasum(REFDAT[test_name][0][0].T, REFDAT[test_name][0][ref_id].T, is_series=False)
...
def test_antiferro_chain():
    ...
    energy, intensity = hamiltonian._energies_and_intensities(QVECS, use_rust=False, intensity_unit='spin')
    _test_ref_data('antiferro_chain', *omegasum(energy, intensity, is_series=False))
    _test_ref_data('antiferro_chain', *omegasum(*hamiltonian._energies_and_intensities(QVECS, use_rust=False,
...
def test_antiferro_with_field():
    ...
    energy, intensity = hamiltonian._energies_and_intensities(QVECS, field=[0,0,7], use_rust=False)
    _test_ref_data('antiferro_chain_with_field', *omegasum(energy, intensity, is_series=False))
    _test_ref_data('antiferro_chain_with_field', *omegasum(*hamiltonian._energies_and_intensities(QVECS, field=[0,0,7],
...
def test_kagome_antiferro():
    ...
    energy, intensity = hamiltonian._energies_and_intensities(QVECS, use_rust=False, use_rotating=False)
    _test_ref_data('kagome_antiferro', *omegasum(energy, intensity, is_series=False))
    _test_ref_data('kagome_antiferro', *omegasum(*hamiltonian._energies_and_intensities(QVECS, use_rust=False,
...
def test_tri_antiferro():
    ...
    hamiltonian = Hamiltonian(sites, exchanges, anisotropies)
    energy, intensity = hamiltonian._energies_and_intensities(QVECS, use_rust=False, use_rotating=True)
    ...
    _test_ref_data('tri_antiferro', *omegasum(*hamiltonian._energies_and_intensities(QVECS, use_rust=False,
...
def test_square_antiferro():
    ...
    _test_ref_data('square_antiferro', *omegasum(*hamiltonian._energies_and_intensities(QVECS, use_rust=False,
