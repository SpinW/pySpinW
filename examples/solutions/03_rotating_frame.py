...
t0 = time.time()
ham.spaghetti_plot(Path([[0,0,0],[10,0,0]]))
t1 = time.time()
...
ex0 = generate_exchanges(struc, bond=1, j=1) + \
       generate_exchanges(struc, bond=1, exchange_type=DMExchange, d_x=0.0, d_y=0.0, d_z=1.0)

ham0 = Hamiltonian(struc, ex0)
t2 = time.time()
ham0.spaghetti_plot(Path([[0,0,0],[1.5,0,0]]))
t3 = time.time()
