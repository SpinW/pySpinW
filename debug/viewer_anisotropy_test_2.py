...
if __name__ == "__main__":
    ...
    anisotropies = [
        ...
        AxisMagnitudeAnisotropy(site=y, direction=[0, 1, 0], a=1),
        AxisMagnitudeAnisotropy(site=z, direction=[0, 0, 1], a=1),
        AxisMagnitudeAnisotropy(site=w, direction=[1, 1, 0], a=-1),
    ]
