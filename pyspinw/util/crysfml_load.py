    ...
    for group_id in range(1651):
        ...
        for i in range(n_wyckoff):
            ...
            for j in range(n_positions):
                ...
                positions_num.append([int(parts[10 * j + k]) for k in range(3)]) # 10n + 0,1,2
                positions_denom.append(int(parts[10 * j + 3])) # 10n + 3
                positions_xyz.append([int(parts[10 * j + k + 4]) for k in range(3)]) # 10n + 4,5,6
                positions_mag.append([int(parts[10 * j + k + 7]) for k in range(3)]) # 10n + 7,8,9
